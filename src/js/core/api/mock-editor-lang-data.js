...
module.exports = {
    ...
    'error-get-book-saves':'Error during obtaining book saves. Text of error is {0}.',
    'required':'Required',
    'required-help':'If\xa0possible,\xa0user has\xa0to\xa0active\xa0action.',
    'save-book-editor-exit':'Unsaved progress exists. Do you still wish to close editor? All unsaved data will be lost!',
    ...
    'load':'Load',
    'save-as':'Save as',
    'save-book-header':'Save book',
    'load-book-header':'Load book',
    'save-name':'Name of save',
    'save-time':'Time of save',
    'action':'Action',
    'unknown-save-id':'Impossible to save book. Used save was not found.',
    'unknown-load-id':"Impossible to load book. Selected save doesn't exists.",
    'save-book-overwrite':'Save with appropriate name already exists. Do you want to overwrite it?',
    'new-save-name':'New save name',
    'type-new-save-name':'Type name of new save',
    'save-name-required':'Save name is required',
    'load-unsaved-progress':'Unsaved data exists. Do you want to still load new data. All unsaved progress will be lost!',
    'load-book-loaded':'Book has been loaded',
    'load-book-no-load':'Book was not properly loaded. Text of the error is {0}.',
    'loader-saving-book':'Saving book',
    'item-workspace-modal-header':'Item module workspace',
    'global':'Global',
    'info':'Info',
    'remove':'Remove',
    'select':'Select',
    ...
    'workspace-data-no-obtained':'Error during workspace data loading. Text of the error is: {0}.',
}